 ...
 */
require_once (dirname(__FILE__) . 'MarketplaceWebService/Interface.php'); 
...
class  MarketplaceWebService_Mock implements MarketplaceWebService_Interface
{
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportScheduleCountResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportRequestListByNextTokenResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/UpdateReportAcknowledgementsResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/SubmitFeedResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportCountResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/CancelFeedSubmissionsResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/RequestReportResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetFeedSubmissionCountResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/CancelReportRequestsResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportListResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetFeedSubmissionResultResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetFeedSubmissionListResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportRequestListResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportScheduleListByNextTokenResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportListByNextTokenResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/ManageReportScheduleResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportRequestCountResponse.php');
    ...
    {
        require_once (dirname(__FILE__) . 'MarketplaceWebService/Model/GetReportScheduleListResponse.php');
